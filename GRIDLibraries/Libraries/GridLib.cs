...
namespace GRIDLibraries.Libraries
{
    public partial class GridLib
    {
        ...
        //string conStringAHS_QA = "Data Source=WPEC5009GRDRP01;" + "Initial Catalog=GRID_AHS_QA" + ";" + "Persist Security Info=True;" + "Integrated Security=SSPI;" + "Connect Timeout=3000;";
